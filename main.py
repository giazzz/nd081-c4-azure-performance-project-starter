...
def index():
    ...
    if request.method == 'GET':
        ...
        with tracer.span(name=f"Total {button1} Voted: {vote1}") as span:
          print(f"Total {button1} Voted: {vote1}")

        vote2 = r.get(button2).decode('utf-8')
        # TODO: use tracer object to trace dog vote
        with tracer.span(name=f"Total {button2} Voted: {vote2}") as span:
          print(f"Total {button2} Voted: {vote2}")
